...
class SubmissionsImport implements ToModel, WithHeadingRow, SkipsEmptyRows
{
    ...
    public function rules(): array
    {
        return [
            ...
            'community_impact' => 'required|string',
            'leadership_challenge' => 'required|string',
            'contribution' => 'required|string',
            'expected_from_adinkra' => 'required|string',
            'leadership_award' => 'required|string',
            'biography' => 'required|string', 
            'motivation_video' => 'required|string',
            'cv' => 'required|string',
